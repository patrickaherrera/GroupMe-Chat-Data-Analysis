...
Assumes filename.json is a JSON GroupMe transcript.
    ...
    #   print(main.__doc__)
    # sys.exit(1)
    parser = GooeyParser(description="My Cool GroupMe Analytics Program!")
    ...
    print '*****************************************************'
    print '*****************************************************'
    print 'Checking the transcript called ' + transcriptFile.name + '...'
    print '*****************************************************'
    print '*****************************************************'
    print '*****************************************************'
    print '\n'
    ...
    print ' '
    print 'Here is a list of those who wrote posts with at least ' + str(minLikes) + ' likes: '
    print ' '
    ...
    for message in transcript:
        ...
        monthCount[int(time) - 1] = monthCount[
                                        int(time) - 1] + 1  # increment the month in which the comment was posted in
    ...
    print '\nMorning (5am-Noon): ' + str(timeOfDay[0]) + ' (' + str(
        "%.1f" % ((timeOfDay[0] / float(total)) * 100)) + '%)'
    print 'Afternoon (Noon-5pm): ' + str(timeOfDay[1]) + ' (' + str(
        "%.1f" % ((timeOfDay[1] / float(total)) * 100)) + '%)'
